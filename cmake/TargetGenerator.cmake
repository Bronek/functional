...
set(EMPTY_TEST_TARGET_TEMPLATE "#include <>\nint main() {}\n")
...
function(setup_target_for_header)
  ...
  string(REPLACE "include <>" "include <${Generator_HEADER}>" file_content ${EMPTY_TEST_TARGET_TEMPLATE})
